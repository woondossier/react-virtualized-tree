 ...
 * @param allowedKeys - Array of key values to listen for (e.g., ['Enter', ' '])
 * @returns Event handler wrapper
 */
export const wrapKeyDownEvent =
  (allowedKeys: string[]) =>
  <T extends unknown[]>(handler: (...params: T) => void) =>
  (event: KeyboardEvent, ...params: T): void => {
