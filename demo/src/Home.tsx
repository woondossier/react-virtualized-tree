...
const Home: React.FC = () => (
  <div>
    ...
    <Segment basic>
      ...
      <p>
        The core idea behind it is that anyone using it is enable to create a tree as they wich
        just by rendering their own components or components exported by the tree
      </p>
    </Segment>
    ...
    <Segment basic>
      <p>
        Most react-virtualized-tree Dependencies are managed internally, the only required
        peerDependencies are <b>react</b>, <b>react-dom</b> and <b>react-virtualized</b>.
      </p>
    </Segment>
  </div>
);
